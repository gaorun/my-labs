...
| 日期       | 版本   | 变更内容                                                                                                                                                                           |
| ---------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-25 | v0.1.0 | 🎉 初始化 monorepo 骨架：建立 packages/skills + packages/cli + packages/extensions 三层结构；迁移 8 个已有 skill；创建 my-cli 元安装器（基于 oclif）；编写 sync-skills.ts 聚合脚本 |
